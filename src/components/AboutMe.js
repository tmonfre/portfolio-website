      ...
      <div className="content-section">
        ...
        <div className="job">
          <p className="job-title">
            <u>
              <strong><a href="http://dali.dartmouth.edu/" target="_blank" rel="noopener noreferrer">Software Developer</a></strong>
              <a href="http://dali.dartmouth.edu/" target="_blank" rel="noopener noreferrer"> — Dartmouth Applied Learning & Innovation Lab</a>
            </u>
          </p>
          ...
          <p>
            ...
            Partnered with the US Forest Service to visualize data on an invasive species impacting east coast forests.
            Built full stack web app with React front-end, Node/Express server (hosted with Heroku), and a NoSQL (mongoDB) database.
            Partnered with a Boston-based start-up to build a mobile food ordering app with React Native and a Node/Express server.
            Have experience building RESTful APIs and integrating full stack apps with cloud computing services.
            Subject Matter Expert in React.js and Node.js for the lab. Hold open help hours and campus-wide workshops.
          </p>
        </div>
        ...
        <div className="job">
          <p className="job-title">
            <u>
              <strong><a href="http://wpshealthsolutions.com/" target="_blank" rel="noopener noreferrer">Finance Innovation Intern</a></strong>
              <a href="http://wpshealthsolutions.com/" target="_blank" rel="noopener noreferrer"> — WPS Health Solutions</a>
            </u>
          </p>
          ...
          <p>
            ...
            Developed a task-tracking system to improve monthly closing processes. Visualized real-time data on task progress and analyzed bottlenecks/dependencies that slowed the process.
            Helped reduce monthly time to close by two days.
          </p>
        </div>
        ...
        <div className="job">
          <p className="job-title">
            <u>
              <strong><a href="https://web.cs.dartmouth.edu/" target="_blank" rel="noopener noreferrer">Teaching Assistant</a></strong>
              <a href="https://web.cs.dartmouth.edu/" target="_blank" rel="noopener noreferrer"> — Dartmouth College Department of Computer Science</a>
            </u>
          </p>
          ...
          <p>
            ...
            Taught weekly lab sections, held regular office hours, and graded assignments/exams.
            Covered topics such as recursion, stacks/queues, classes/objects, BFS/DFS, and more.
          </p>
        </div>
        ...
        <div className="job">
          <p className="job-title">
            <u>
              <strong><a href="http://www.qualityinsulators.com/" target="_blank" rel="noopener noreferrer">Technology Development Intern</a></strong>
              <a href="http://www.qualityinsulators.com/" target="_blank" rel="noopener noreferrer"> — Quality Insulators, Inc.</a>
            </u>
          </p>
      ...
      <div className="content-section">
        ...
        <div className="activity">
          <p className="job-title">
            <u>
              <strong>
                <a href="https://students.dartmouth.edu/academic-skills/tutor-clearinghouse/about-tutor-clearinghouse" target="_blank" rel="noopener noreferrer">Computer Science Tutor</a>
              </strong>
              <a href="https://students.dartmouth.edu/academic-skills/tutor-clearinghouse/about-tutor-clearinghouse" target="_blank" rel="noopener noreferrer"> — Dartmouth Tutor Clearinghouse</a>
            </u>
          </p>
        ...
        <div className="activity">
          <p className="job-title">
            <u>
              <strong><a href="https://recreation.dartmouth.edu/physical-education/courses/snowsports/snowsport-classes" target="_blank" rel="noopener noreferrer">Alpine Ski Instructor</a></strong>
              <a href="https://recreation.dartmouth.edu/physical-education/courses/snowsports/snowsport-classes" target="_blank" rel="noopener noreferrer"> — Dartmouth PE Snowsports Program</a>
            </u>
          </p>
          <p className="duration">January, 2018 - March, 2018</p>
          <div style={{ clear: 'both' }} />
