                ...
                <div className="dev-samples">
                    <div className="left">
                        <div className="dev-sample-area">
                            ...
                            <p>DALI Lab project that partnered with the US Forest Service to visualize and predict outbreaks of an invasive species on the east coast. Front-end was built with React.js. Back-end was built with Node.js/Express.js and a mongoDB database. Data visualization was built with Chart.js. Used a predictive model written in R that runs a linear regression on historical data to predict future outbreaks.</p>
                        ...
                        <div className="dev-sample-area">
                            ...
                            <p>Project built for Dartmouth CS52: Full Stack Web Development. This React app allows users to login, create, view, and edit blog posts. Changes persist in real-time across devices with a Node/Express server. Authentication of user and routes is handled on server. Only verified users can edit their own posts, and delete their own posts.</p>
                            <em><p>View the frontend code <a href="https://github.com/dartmouth-cs52-19S/lab4-tmonfre" target="_blank" rel="noopener noreferrer">here</a>, and the backend code <a href="https://github.com/dartmouth-cs52-19S/lab5-tmonfre" target="_blank" rel="noopener noreferrer">here.</a></p></em>
                    ...
                    <div className="right">
                        <div className="dev-sample-area">
                            <h2>6amhealth</h2>
                            <p>DALI Lab project that partnered with a Boston-based start-up focused on providing accessible, healthy meal options to customers via the fresh fridge vending system. Built a React Native app that allows users to find fresh fridges nearby, place orders, and pay for food. Built a Node/Express server and integrated authentication with Firebase. Use Stripe for processing payments.</p>
                            <em><p>Under active development! Check out the latest screen recordings <a href="https://drive.google.com/drive/folders/1qUUD9AEsorhplgpG-hiUeM0bL4uYDJ8O?usp=sharing" target="_blank" rel="noopener noreferrer">here.</a></p></em>
                        ...
                        <div className="dev-sample-area">
                            <h2>React Notes</h2>
                            <p>Project built for Dartmouth CS52: Full Stack Web Development. This React app allows users to login, create, view, and edit notes. Changes persist in real-time across devices. Authentication is handled with Firebase.</p>
                            <em><p>View the code <a href="https://github.com/dartmouth-cs52-19S/lab3-tmonfre" target="_blank" rel="noopener noreferrer">here.</a> Visit the website <a href="https://cs52-react-notes.surge.sh/" target="_blank" rel="noopener noreferrer">here.</a></p></em>
