        ...
        return(
            <div id="classes">
                ...
                <div className="course-dropdown" onClick={this.handleTitleClick}>
                    ...
                    <p className="description">The Web is a powerful delivery tool for complex real-time applications.  This is an introduction to full stack Web application development — the approach of integrating numerous techniques and technologies to build modern Web applications.  Topics include: static pages, Internet protocols, layout, markup, event-driven asynchronous programming, deployment, security, scalability, and user experience. Projects include building real-time Web applications with front-end UIs and server-side APIs.</p>
                </div>

                <div className="course-dropdown" onClick={this.handleTitleClick}>
                    <p className="title">ECON 20: Econometrics</p>
                    <p className="description">Econometrics is the statistical analysis of economic data. This course focuses on regression analysis (specification, estimation, and hypothesis testing) and problems and pitfalls in its application in economics. The course involves extensive use of the statistical program STATA and will enable students to implement their own empirical research projects in preparation for the culminating experience in the economics major.</p>
                </div>

                <div className="course-dropdown" onClick={this.handleTitleClick}>
                    <p className="title">ASTR 19: Habitable Planets</p>
