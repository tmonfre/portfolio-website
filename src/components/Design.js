      ...
      <Fade up>
        <div className="design-samples">
          ...
          <div className="right">
            ...
            <em><p>Navigate to <a href="http://www.qualityinsulators.com/" target="_blank" rel="noopener noreferrer">the following link</a> to view this live website.</p></em>
          ...
          <div className="left">
            ...
            <p>
              Throughout my life, I’ve created several Snapchat filters for events, including my high school graduation, prom, and a local concert.
              I’ve also published community filters for prominent locations in my area. Below are two examples I&aposve created.
            </p>
            <em><p>Click through the images in the album below.</p></em>
          ...
          <div className="right">
            ...
            <p>My senior year of high school, I was put in charge of co-directing the annual Mr. Bay Port Guy Pageant.
              In addition to planning this event, I designed all of the marketing materials. Below are presentation boards and logo
              designs from the project.
            </p>
            <em><p>Click through the images in the album below.</p></em>
